...
Ещё 6 многослойных сложных иконок (leaves, wind, antibacterial, virus, target,
один безымянный `Variant22` → назвал `smile` по форме, не подтверждено)
добавлены в `sprite.svg` **как есть, без ручной сборки** (18.08.2026, по
просьбе — сам доведёт руками). Что сделал при вставке:
